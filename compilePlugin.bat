...
@JAVAC %1 -cp "\\Roose_group\M_Warren\Fiji_201610_JAVA8.app\jars\*";\\Roose_group\M_Warren\RootSegmentation\ -d \\Roose_group\M_Warren\RootSegmentation\requiredClassFiles
