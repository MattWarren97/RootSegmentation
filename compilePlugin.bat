...
@JAVAC %1 -cp \\Roose_group\M_Warren\Fiji_201610_JAVA8.app\jars\ij-1.51g.jar;\\Roose_group\M_Warren\RootSegmentation\jars\commons-collections4-4.0.jar;\\Roose_group\M_Warren\RootSegmentation\ -d \\Roose_group\M_Warren\Fiji_201610_JAVA8.app\plugins
