...
public class AA_LocalIterative implements PlugInFilter {
	...
	static int xStart = 218;
	static int yStart = 298;
	static int zStart = 1;
	...
	public void run(ImageProcessor ip) {
		...
		Rectangle r2 = focusArea.getBounds();
		System.out.println("new focus area was- X: " + ((int) r2.getX()) + ", Y: " + ((int) r2.getY()) + ", Width: " + ((int) r2.getWidth()) + ", Height: " + ((int) r2.getHeight()));
		iPlusCopy.deleteRoi();
		iPlus.deleteRoi();
